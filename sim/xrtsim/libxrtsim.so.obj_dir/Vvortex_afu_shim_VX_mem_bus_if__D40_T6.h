...
class alignas(VL_CACHE_LINE_BYTES) Vvortex_afu_shim_VX_mem_bus_if__D40_T6 final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    VlWide<20>/*611:0*/ req_data;
    VlWide<17>/*517:0*/ rsp_data;

    // INTERNAL VARIABLES
    Vvortex_afu_shim__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vvortex_afu_shim_VX_mem_bus_if__D40_T6(Vvortex_afu_shim__Syms* symsp, const char* v__name);
...
std::string VL_TO_STRING(const Vvortex_afu_shim_VX_mem_bus_if__D40_T6* obj);
