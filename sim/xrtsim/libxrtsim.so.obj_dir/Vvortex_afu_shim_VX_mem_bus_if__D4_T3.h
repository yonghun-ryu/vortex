...
class alignas(VL_CACHE_LINE_BYTES) Vvortex_afu_shim_VX_mem_bus_if__D4_T3 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vvortex_afu_shim_VX_mem_bus_if__D4_T3(Vvortex_afu_shim__Syms* symsp, const char* v__name);
