...
class alignas(VL_CACHE_LINE_BYTES) Vvortex_afu_shim_VX_decode_if final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vvortex_afu_shim_VX_decode_if(Vvortex_afu_shim__Syms* symsp, const char* v__name);
...
std::string VL_TO_STRING(const Vvortex_afu_shim_VX_decode_if* obj);
