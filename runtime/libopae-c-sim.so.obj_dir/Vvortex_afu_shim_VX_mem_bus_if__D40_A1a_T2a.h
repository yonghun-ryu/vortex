...
class alignas(VL_CACHE_LINE_BYTES) Vvortex_afu_shim_VX_mem_bus_if__D40_A1a_T2a final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    VlWide<21>/*647:0*/ req_data;
    VlWide<18>/*553:0*/ rsp_data;

    // INTERNAL VARIABLES
    Vvortex_afu_shim__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vvortex_afu_shim_VX_mem_bus_if__D40_A1a_T2a(Vvortex_afu_shim__Syms* symsp, const char* v__name);
