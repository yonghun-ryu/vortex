...
class alignas(VL_CACHE_LINE_BYTES) Vvortex_afu_shim_VX_mem_bus_if__D40_T9 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vvortex_afu_shim_VX_mem_bus_if__D40_T9(Vvortex_afu_shim__Syms* symsp, const char* v__name);
...
std::string VL_TO_STRING(const Vvortex_afu_shim_VX_mem_bus_if__D40_T9* obj);
