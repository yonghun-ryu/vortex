...
VL_INLINE_OPT void Vvortex_afu_shim_VX_gpu_pkg____Vdpiimwrap_dpi_trace_TOP__VX_gpu_pkg(IData/*31:0*/ level, std::string format) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                          Vvortex_afu_shim_VX_gpu_pkg____Vdpiimwrap_dpi_trace_TOP__VX_gpu_pkg\n"); );
    // Body
    int level__Vcvt;
